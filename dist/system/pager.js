...
System.register(['aurelia-framework'], function (_export, _context) {
	...
	var customElement, bindable, inject, computedFrom, _createClass, _dec, _dec2, _dec3, _dec4, _class, _desc, _value, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, PagingStrategy, METHOD, SORT_ORDER, PAGER_DEFAULTS, Pager;
	...
	return {
		...
		execute: function () {
			...
			_export('PagingStrategy', PagingStrategy = function PagingStrategy(options) {
			...
			_export('PagingStrategy', PagingStrategy);
			...
			_export('default', Pager = (_dec = customElement('pager'), _dec2 = inject(Element), _dec3 = computedFrom('numPages', 'requireMultiplePages'), _dec4 = computedFrom('numPages', 'pageNumber', 'pageSize'), _dec(_class = _dec2(_class = (_class2 = function () {
